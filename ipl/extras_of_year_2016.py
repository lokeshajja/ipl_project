...
def years_and_ids(matches_of_2016, deliveries_data):
...
def extra_runs_conceived_by_each_team_in_2016(matches, deliveries_data):

    matches_of_2016 = year_and_id_data(matches)
    extra_runs_data = years_and_ids(matches_of_2016, deliveries_data)

    return extra_runs_data


def plot_of_extra_runs_given_by_each_team_in_2016(plot_data):
