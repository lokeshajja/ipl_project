...
class TestPlotData(unittest.TestCase):
    ...
    def test_economy_of_bowlers(self):
        ...
        bowler_data={'UT Yadav': {'balls': 60, 'runs': 40}, 'M Morkel': {'balls': 120, 'runs': 100}, 'Shakib Al Hasan': {'balls': 60, 'runs': 50}}
        economy_data={'UT Yadav': 4, 'M Morkel': 5, 'Shakib Al Hasan': 5 }
